...
import customDashboards from './routes/dashboards.js';
import contentLibrary from './routes/library.js';
...
app.use('/api/dashboards', customDashboards);
app.use('/api/libraries', contentLibrary);
