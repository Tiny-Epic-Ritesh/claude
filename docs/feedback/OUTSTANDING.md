...
| `OPS-12` | Bulk-setting `stage` (`/leads/bulk/field` and the list bulk field) takes `lead.edit` alone, where PATCH and the list bulk stage require `lead.stage.change`. Found 18 Sep beside `OPS-11`. | **Open** — not started |
